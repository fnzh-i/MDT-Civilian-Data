...
<body>
    ...
    <form action="AdminUser.php" method="POST">
        ...
        Role:
        <input type="radio" name="role" id="user" value="USER" <?php if($role === 'USER') echo 'checked'; ?>>
        <label for="user">USER</label>

        <input type="radio" name="role" id="enforcer" value="ENFORCER" <?php if($role === 'ENFORCER') echo 'checked'; ?>>
        <label for="enforcer">ENFORCER</label>

        <input type="radio" name="role" id="supervisor" value="SUPERVISOR" <?php if($role === 'SUPERVISOR') echo 'checked'; ?>>
        ...
        <input type="<?php echo ($id > 0) ? 'text' : 'password'; ?>"
            name="password" id="password" value="<?php echo htmlspecialchars($password); ?>">
        <br><br>
