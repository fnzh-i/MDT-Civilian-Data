...
<head>
  ...
  <title>MDT Admin Search Vehicle</title>
  ...
  <nav class="bg-blue-600 shadow-lg px-6 py-3 relative flex justify-between items-center sticky top-0 z-50">
    ...
    <div class="absolute left-1/2 transform -translate-x-1/2">
      <a href="../admin_dashboard.php"
        ...
        <span>MDT Admin (Search & Edit Vehicle)</span>
      </a>
    </div>
  ...
  <div class="flex flex-col md:flex-row"> <!-- sidebar (Admin Version) -->
    ...
    <div class="flex flex-col items-center justify-start px-4 w-full mt-32 md:mt-0 py-32">
      <div class="bg-white p-8 rounded-2xl shadow-xl max-w-xl mx-auto">
        <h1 class="text-3xl font-extrabold text-gray-800 mb-6">Search Vehicle</h1>

        <form action="AdminSearchVehicleResult.php" method="GET" class="space-y-6">
          <input type="hidden" name="action" value="SEARCH-PLATE-NUMBER">

          <div>
            <label class="font-semibold text-gray-700">Enter Plate or MV File Number</label>
            <input type="text" id="search-vehicle" name="plate-number" placeholder="ABC-1234 / MV-0123456789"
