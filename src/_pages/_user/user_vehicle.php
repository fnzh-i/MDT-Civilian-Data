...
<body class="bg-gray-200" data-license-id="<?= $_SESSION['license_id'] ?>">
    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div class="flex flex-col md:ml-56 w-full px-6 py-10">
            ...
            <h1 class="text-4xl font-extrabold mb-2 text-gray-800">User Vehicles</h1>
            <p class="text-lg text-gray-600 mb-8">Overview of your vehicles</p>

            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">

                <!-- VEHICLES PANEL -->
                <div id="vehicleFull" class="bg-white rounded-2xl shadow-xl p-6"></div>
